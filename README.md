...
- **`/ros/launch/stereo.launch`**  
  Launch-Datei zum Starten des ORB-SLAM2 Systems im Stereo-Modus.

- **`/orb_slam2/stereo_publisher.py`**  
  Python-Skript, das Bildpaare aus einem Ordner einliest und als ROS-Topics veröffentlicht.  
  Als Argument kann der Pfad zum Bildordner übergeben werden, wodurch ein echter Kamera-Feed ersetzt wird.
